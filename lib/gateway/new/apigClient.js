...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://0f5dmn5q21.execute-api.us-west-1.amazonaws.com/demo';
    ...
    apigClient.corsGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        ...
        var corsGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/cors').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(corsGetRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.corsOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var corsOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/cors').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
        ...
        return apiGatewayClient.makeRequest(corsOptionsRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.noAuthGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var noAuthGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/no-auth').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(noAuthGetRequest, authType, additionalParams, config.apiKey);
    };
    ...
    apigClient.sampleServiceGet = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var sampleServiceGetRequest = {
            verb: 'get'.toUpperCase(),
            path: pathComponent + uritemplate('/sample-service').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, ['david']),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        
        
        return apiGatewayClient.makeRequest(sampleServiceGetRequest, authType, additionalParams, config.apiKey);
    };
